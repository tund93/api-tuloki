...
export class Migration20231003073515 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "category" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "name" varchar(255) not null, "description" varchar(255) not null);');
    ...
    this.addSql('create table "conversation" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "chat_name" varchar(255) not null);');
    ...
    this.addSql('create table "news_letter" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "name" varchar(255) not null, "content" text not null, "sent_at" timestamptz(0) null);');
    ...
    this.addSql('create table "protocol" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "login_attemptnumbererval" int not null, "loginnumbererval_unit" varchar(255) not null, "login_max_retry" int not null, "otp_expiry_in_minutes" int not null);');
    this.addSql('create index "protocol_id_index" on "protocol" ("id");');
    this.addSql('create index "protocol_idx_index" on "protocol" ("idx");');

    this.addSql('create table "subscriber" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "email" varchar(255) not null);');
    ...
    this.addSql('create table "tag" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "title" varchar(50) not null, "description" text not null, "slug" varchar(255) null);');
    ...
    this.addSql('create table "refresh_token" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "expires_in" timestamptz(0) not null, "user_id" int not null, "is_revoked" boolean null default false);');
    ...
    this.addSql('create table "referral" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "referrer_id" int not null, "mobile_number" varchar(255) not null, "status" text check ("status" in (\'PENDING\', \'COMPLETED\')) not null default \'PENDING\');');
    ...
    this.addSql('create table "post" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "slug" varchar(255) null, "title" varchar(255) not null, "description" text not null, "content" text not null, "reading_time" int null default 0, "read_count" int null default 0, "favorites_count" int null default 0, "author_id" int not null, "state" text check ("state" in (\'DRAFT\', \'PUBLISHED\')) null default \'DRAFT\');');
    ...
    this.addSql('create table "message" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "body" varchar(255) not null, "sender_id" int not null, "conversation_id" int not null, "is_read" boolean null default false, "read_at" timestamptz(0) null);');
    ...
    this.addSql('create table "point_redemption_log" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "points" int not null, "amount" numeric(9,2) not null, "user_id" int not null);');
    ...
    this.addSql('create table "otp_log" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "expires_in" timestamptz(0) not null, "otp_code" varchar(20) null, "user_id" int not null, "is_used" boolean null default false);');
    ...
    this.addSql('create table "comment" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" varchar(255) null, "updated_at" varchar(255) null, "body" varchar(255) not null, "post_id" int not null, "author_id" int not null);');
    ...
    this.addSql('alter table "message" add constraint "message_sender_id_foreign" foreign key ("sender_id") references "post" ("id") on update cascade;');
